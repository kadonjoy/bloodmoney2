            ...
            <div className="bg-gray-900 rounded-xl p-8 max-w-lg w-full text-left relative">
              ...
              <ol className="list-decimal list-inside space-y-2 text-white text-lg">
                ...
                <li>
                  ...
                  money. Poor decisions can lead to burnout, debt, or unexpected
                  consequences.
                </li>
                <li>
                ...
                <li>
                  Experience Satire: Enjoy the dark humor and social commentary
                  as you manage Harvey&apos;s life in a world where every action
                  has a price.
                </li>
              </ol>
            </div>
